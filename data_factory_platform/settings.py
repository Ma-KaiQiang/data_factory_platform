"""
Django settings for data_factory_platform project.
...
SECRET_KEY = 'django-insecure-@lu27lt%#p6r1wwj8%h5c1s_(0+##el5l=h+8+^&7r#bqssyr!'
...
ROOT_URLCONF = 'data_factory_platform.urls'
...
WSGI_APPLICATION = 'data_factory_platform.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'filename': '{}/Log/data_sync_{}.log'.format(BASE_DIR, datetime.datetime.now().date()),  # 日志输出文件
